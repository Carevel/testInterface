 ...
 * 
 */
@WebServiceClient(name = "WebService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://60.209.152.68:60083/SendToCityGrid/WebService.asmx?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://60.209.152.68:60083/SendToCityGrid/WebService.asmx?wsdl");
    ...
    public WebServiceHttpGet getWebServiceHttpGet() {
        return super.getPort(new QName("http://tempuri.org/", "WebServiceHttpGet"), WebServiceHttpGet.class);
    }
    ...
    public WebServiceHttpGet getWebServiceHttpGet(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "WebServiceHttpGet"), WebServiceHttpGet.class, features);
    }
    ...
    public WebServiceHttpPost getWebServiceHttpPost() {
        return super.getPort(new QName("http://tempuri.org/", "WebServiceHttpPost"), WebServiceHttpPost.class);
    }
    ...
    public WebServiceHttpPost getWebServiceHttpPost(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "WebServiceHttpPost"), WebServiceHttpPost.class, features);
    }
